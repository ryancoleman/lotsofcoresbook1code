...
extern "C" 
#endif
void pdgetrf_ooc2( int *m_in, int *n_in, 
...
const int use_pdgetrf_gpu2 = TRUE;
...
if ((is_root)  && (idebug >= 0)) {
  printf("pdgetrf_ooc2: mm %d nn %d mb %d nb %d isize %d \n",
                        mm,nn, mb,nb, isize );
  printf("pdgetrf_ooc2: memsize %d npanels %d nby %d\n",
      memsize, npanels, nby );
};
 ...
 */
              ...
              Cpdgecopy_d2h( mm,nn, dY, iy,jy,   descY, 
                                    hY, ihY,jhY, deschY );
              cublas_sync_stream();
              ...
              if (idebug >= 1) {
                ...
                Cpdlaprnt( mm,nn,hY,ihY,jhY,descY,hY_name);
                ...
                /*
                   ...
                   ilen = strlen(hY_name);
                   scalapack_pdlaprnt( &mm,&nn,hY,&ihY,&jhY,deschY,
                    &irprnt,&icprnt,
                ...
                Cpdlaprnt(mm,mm,dX,iix,jjx,descX,dX_name);
                ...
                /*
                   ...
                   work = (double *) malloc( nbytes );
                   ilen = strlen(dX_name);
                   scalapack_pdlaprnt( &mm,&mm, dX,&iix,&jjx,descX,
                     &irprnt,&icprnt,
 ...
 */
             ...
             if (has_work)  {
              ...
              if (idebug >= 1) {
                ...
                Cpdlaprnt(mm,kk,dX,iix,jjx,descX,cmatnm);
                ...
                /*
                   ...
                   nbytes = MAX( nbytes, 1024*1024 );
                   work = (double *) malloc( nbytes );
                  scalapack_pdlaprnt( &mm,&kk, dX, &iix,&jjx,descX, 
               ...
               */
                ...
                mm = ksize;
                nn = jsize;
                Cpdgecopy_h2d( mm,nn, hY,ihY,jhY,deschY,
                             dY, iy,jy,descY );
                 };
 ...
 */
            ...
            nn = jsize;
             ...
             /*
              * similar to pdgetrf( &mm,&nn,Y,j,1,&descY, &(ipivY(1)), &iinfo);
             */
             iy = j; 
             jy = 1;
             has_work = (mm >= 1) && (nn >= 1);
             if (has_work) {
               ...
               if (use_pdgetrf_gpu2) {
                 ...
                 PROFSTART("Y:pdgetrf_gpu2");
                 pdgetrf_gpu2( &mm_lu, &nn_lu, 
                   dY,&iy_lu,&jy_lu,descY, 
                   A, &iah0, &jah0, descA,
                   &(ipiv(1)), &iinfo );
                 PROFEND("Y:pdgetrf_gpu2");
                 ...
                 PROFSTART("Y:pdgetrf_gpu");
                 pdgetrf_gpu( &mm_lu, &nn_lu, 
                   dY,&iy_lu,&jy_lu,descY, &(ipivY(1)), &iinfo );
                 PROFEND("Y:pdgetrf_gpu");
               };
             };
             ...
             if (idebug >= 2) {
               char cmatnm[] = "dY2";
               if (is_root) { printf("after pdgetrf_gpu\n"); };
             ...
             if (has_work) {
               if (iinfo < 0) {
                 *info = iinfo;
                 if (idebug >= 1) {
                   printf("pdgetrf_ooc2: pdgetrf return iinfo=%d\n", iinfo);
                 };
                 return;
                 };
               if (iinfo > 0) {
 ...
 */
            ...
            if (use_immediate_copy_to_host) {
              ...
              iia = (ia-1) + 1;
              jja = (ja-1) + jstart;
              Cpdgecopy_d2h( mm,nn,  dY,1,1,descY, 
                                   A,iia,jja,descA );
            };
 ...
 */
            ...
            for(int kk=k1; kk <= k2; kk++) {
              ...
              if (ip != kk) {
                 ...
                 j2 = j1;
                 if (nn >= 1) {
                   scalapack_pdswap( &nn,  A,&i1,&j1,descA,&inc1,
                                           A,&i2,&j2,descA,&inc2);
                   };
...
extern "C"
#endif
void pdgetrf_ooc2_( int *m_in, int *n_in,
                 double *A, int *ia_in, int *ja_in, int *descA, 
                          int *ipiv_,  int *memsize_in, int *info )
{
  pdgetrf_ooc2( m_in, n_in,
               A, ia_in, ja_in, descA,
