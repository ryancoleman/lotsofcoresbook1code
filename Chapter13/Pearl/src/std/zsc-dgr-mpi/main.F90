!-------------------------------------------------------------------------------
! Program  : ZSC-2D-DGR-MPI
! Revision : 1.0 (2008-06-15)
! Author   : David S. Whyte [david(at)ihpc.a-star.edu.sg]
!            Carlos Rosales Fernandez [carlos.rosales.fernandez(at)gmail.com]
!-------------------------------------------------------------------------------
!> @file
!! Driver for the dual grid parallel D2Q5/D2Q9 Zheng-Shu-Chew multiphase LBM
!> @details
!! Driver for the dual grid parallel implementation of the Zheng-Shu-Chew
...
! Read input parameters and generate virtual CPU grid
 CALL Parameters
 CALL VGrid
