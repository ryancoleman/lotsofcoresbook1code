...
!! the parallel D3Q7/D3Q19 Zheng-Shu-Chew multiphase LBM.
...
! Chemical potential
       muphin = alpha4*phin*( phin2 - phistar*phiStar ) - kappa*lapPhi
