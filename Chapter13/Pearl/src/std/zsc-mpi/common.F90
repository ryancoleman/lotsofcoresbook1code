...
!> @brief Parameters related to hydrodynamics quantities
 ...
 REAL(KIND = DBL) :: rhoPhiStar, tauRhoStar
...
! Information exchange buffers (y direction)
 ...
 REAL(KIND = DBL), ALLOCATABLE, DIMENSION(:) :: phi_north_snd, phi_south_snd
 REAL(KIND = DBL), ALLOCATABLE, DIMENSION(:) :: phi_north_rcv, phi_south_rcv

! Information exchange buffers (diagonals)
 REAL(KIND = DBL) :: phi_ne_snd, phi_ne_rcv, phi_se_snd, phi_se_rcv
 REAL(KIND = DBL) :: phi_nw_snd, phi_nw_rcv, phi_sw_snd, phi_sw_rcv
