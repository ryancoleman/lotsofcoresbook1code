#$Id: GNUmakefile 25621 2014-05-15 00:02:47Z kowalski $
#
...
OBJ_OPTIMIZE = tce_tile.o tce_ao1e.o tce_mo1e.o tce_ao2e.o \
      ...
      tce_hash.o get_hash_block.o put_hash_block.o add_hash_block.o tce_sort_4kg.o \
      ...
      tce_make_denom1.o tce_make_denom2.o get_hash_block_ma.o \
...
ifdef SPAGHETTYSORT
      OBJ_OPTIMIZE += tce_sort0.o tce_sort2_saday.o tce_sort4_jeff.o tce_sort6.o tce_sort8.o \
                      tce_sortacc_saday.o tce_sortacc8.o 
      LIB_DEFINES += -DSPAGHETTY
else
      OBJ_OPTIMIZE += tce_sort.o tce_sortacc.o
      #OBJ_OPTIMIZE += tce_sort8.o tce_sortacc8.o tce_sortacc_saday.o tce_sort_saday.o
endif
...
USES_BLAS = tce_mbpt2.F tce_residual_t1.F tce_residual_t2.F \
            ...
            ccsd_imaginary.F ccsd_lr_alpha.F ccsd_lr_beta.F tensor_read_write.F \
