/*
 $Id: pdspevx_f.c 19708 2010-10-29 18:04:21Z d3y133 $
 *======================================================================
 *
 * DISCLAIMER
 *
...
void pdspevx_( ivector, irange, n, matrixA, mapA, lb, ub, ilb, iub, abstol,
    ...
    Integer            *ivector, *irange, *n, *mapA, *ilb, *iub, *meigval,
     ...
     DoublePrecision         *lb, *ub, *abstol, *eval, *scratch, *matrixA, *matZ, *dblptr;
{
  
/*
 *----------------------------------------------------------------------
 *
 * FORTRAN wrapper for pdspevx.
 *
