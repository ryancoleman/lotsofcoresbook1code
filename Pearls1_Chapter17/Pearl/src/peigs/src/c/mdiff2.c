/*
 $Id: mdiff2.c 19708 2010-10-29 18:04:21Z d3y133 $
 *======================================================================
 *
 * DISCLAIMER
 *
...
void mdiff2_( nA, mapA, nB, mapB, nZ, mapZ, proclist, ndiff )

  Integer      *nA, *mapA, *nB, *mapB, *nZ, *mapZ, *proclist, *ndiff;
     
/*
 *  Returns a list of any processor ids in mapA and/or mapB but not mapZ.
 *  i.e., proclist = ({mapA} U {mapB})  - {mapZ}
 *
 *  ON ENTRY
 *  --------
 *
 ...
 *
 *    mapB ....... B list of nB processor ids.  All ids must be 0 <= id < mxnprc_().
 *
 ...
 *  -------
 *
 *    ndiff ...... = 0 then all processor ids appearing in mapA and/or mapB also appear
 *                          mapZ.
 *                 > 0 then mapA and/or mapB have processor ids which do not appear in
 *                          mapZ.
 *
 *    proclist ... If ndiff = 0: then junk
 *                 Otherwise:    The first ndiff elements is a list of the processor
 *                               ids (without any repeats)
 *                               which appear in mapA and/or mapB, but not mapZ, sorted
 *                               in increasing order.
 *                         
 */
